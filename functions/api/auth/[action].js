...
import { signToken, getAuthPayload } from '../../../src/core/auth/auth.js';
...
async function handleLogin(request, env) {
    try {
        ...
        if (err && err.name === 'ConfigurationError') {
    ...
    try {
        ...
        let user = await getUser(usernameClean, env);
...
async function ensureSeeder(env) {
